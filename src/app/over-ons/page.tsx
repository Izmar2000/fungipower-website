    ...
    return (
        <div className="min-h-screen bg-background flex flex-col">
            <div className="bg-gradient-to-br from-[#CC4400] via-[#E65100] to-[#A33600] relative">
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 pt-56 md:pt-64 pb-24 relative z-10">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                                <p>
                                    Jan Klerken heeft jarenlange ervaring in de champignonsector. Als oprichter van <span className="text-foreground font-bold">Scelta Mushrooms</span>, een van de grootste en meest innovatieve champignonbedrijven van Europa, brengt hij een ongeëvenaard netwerk en diepgaande kennis naar FungiPower.
                                </p>
                                <p>
