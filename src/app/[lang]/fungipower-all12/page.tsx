...
// Product page for FungiPower ALL12
...
export async function generateMetadata(
    ...
    return {
        title: isDE ? 'FungiPower All12 | Professioneller Nährstoff-Transport' : isNL ? 'FungiPower All12 | Professionele Nutriënt Transport' : 'FungiPower All12 | Professional Nutrient Transport',
        description: isDE ? 'Entdecken Sie FungiPower All12 - die ultimative Nährstoff-Transport-Technologie für professionelle Erzeuger.' : isNL ? 'Ontdek FungiPower All12 - de ultieme nutriënt transport technologie voor professionele kwekers.' : 'Discover FungiPower All12 - the ultimate nutrient transport technology for professional growers.',
        openGraph: {
            title: isDE ? 'FungiPower All12 | Professioneller Nährstoff-Transport' : isNL ? 'FungiPower All12 | Professionele Nutriënt Transport' : 'FungiPower All12 | Professional Nutrient Transport',
            ...
            images: ['/images/products/fungipower-all12-transparant.png'],
        }
    }
}
...
export default async function ProductAll12({
    ...
    const content = {
        title: isDE ? 'FungiPower All12 | Professioneller Nährstoff-Transport' : isNL ? 'FungiPower All12 | Professionele Nutriënt Transport' : 'FungiPower All12 | Professional Nutrient Transport',
        meta: isDE ? 'Entdecken Sie FungiPower All12 - die ultimative Nährstoff-Transport-Technologie.' : isNL ? 'Ontdek FungiPower All12 - de ultieme nutriënt transport technologie.' : 'Discover FungiPower All12 - the ultimate nutrient transport technology.',
        heroBadge: isDE ? 'Biologische Innovation' : isNL ? 'Biologische Innovatie' : 'Biological Innovation',
        heroTitle: <><span className="text-white">FUNGIPOWER</span><br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-500">START</span></>,
        heroDesc: isDE
        ...
        efficiencyTitle: isDE ? <>Maximale <span className="text-orange-400">Effizienz</span></> : isNL ? <>Maximale <span className="text-orange-400">efficiëntie</span></> : <>Maximum <span className="text-orange-400">efficiency</span></>,
        cards: [
            {
                title: isDE ? "Passiver Transport" : isNL ? "Passief Transport" : "Passive Transport",
                desc: isDE
                    ? "FungiPower nutzt organische Nanotubes, die sich an Nährstoffe binden, für eine passive Aufnahme ohne Energieverlust."
                    : isNL
                        ? "FungiPower maakt gebruik van organische nanotubes die zich hechten aan voedingsstoffen voor passieve opname zonder energieverlies."
                        : "FungiPower uses organic nanotubes that attach to nutrients for passive uptake without energy loss."
            },
            {
        ...
        spectrumTitle: isDE ? <>Die Kraft der <br /><span className="text-orange-500">zwölf Elemente</span></> : isNL ? <>De kracht van <br /><span className="text-orange-500">twaalf elementen</span></> : <>The power of <br /><span className="text-orange-500">twelve elements</span></>,
        spectrumDesc: isDE
        ...
        advantageTitle: isDE ? <>Revolutionärer <br /><span className="text-orange-500">Transport</span></> : isNL ? <>Revolutionair <br /><span className="text-orange-500">transport</span></> : <>Revolutionary <br /><span className="text-orange-500">transport</span></>,
        advantageDesc: isDE
            ? 'FungiPower All12 ist nicht nur ein Zusatz; es ist der Motor hinter Ihrem Ernährungsplan. Durch den Einsatz der Nano-Transport-Technologie werden Blockaden im Boden aufgehoben und Nährstoffe erreichen die Pflanze schneller als je zuvor.'
            : isNL
                ? 'FungiPower All12 is niet zomaar een toevoeging; het is de motor achter je voedingsschema. Door gebruik te maken van nano-transport technologie worden blokkades in de bodem opgeheven en bereiken voedingsstoffen de plant sneller dan ooit tevoren.'
                : 'FungiPower All12 is not just an additive; it is the engine behind your nutrition schedule. By using nano-transport technology, soil blockages are removed and nutrients reach the plant faster than ever before.',
        usps: isDE
        ...
        steps: [
            ...
            { step: "02", title: isDE ? "Optimale Dosierung" : isNL ? "Optimale dosering" : "Optimal dosage", desc: isDE ? "Verwenden Sie 5 ml FungiPower All12 pro 1 Liter Nährstoffwasser für maximale Wirkung." : isNL ? "Gebruik 5 ml FungiPower All12 per 1 liter voedingswater voor een maximaal effect." : "Use 5 ml FungiPower All12 per 1 liter of nutrient water for maximum effect." },
        ...
        disclaimer: isDE
            ? "FungiPower All12 ist als nicht gefährlich eingestuft und bei korrektem Gebrauch in professionellen Gewächshäusern und landwirtschaftlichen Umgebungen zu 100% sicher."
            : isNL
                ? "FungiPower All12 is geclassificeerd als niet-gevaarlijk en is 100% veilig bij correct gebruik in professionele kassen en landbouwomgevingen."
                : "FungiPower All12 is classified as non-hazardous and is 100% safe when used correctly in professional greenhouses and agricultural environments.",
        technicalTitle: dict.Products.technicalData,
        technicalDesc: isDE
            ? 'Zugang zur offiziellen Dokumentation und den Spezifikationen von FungiPower All12.'
            : isNL
                ? 'Toegang tot de officiële documentatie en specificaties van FungiPower All12.'
                : 'Access to official documentation and specifications of FungiPower All12.',
        ...
        sdsLink: isDE ? '/images/products/sds-all12.pdf' : isNL ? '/docs/FungiPower%20ALL12%20SDS%20NL.pdf' : '/images/products/sds-all12.pdf',
                ...
                <div className="relative pt-24 md:pt-32 pb-16">
                    ...
                    <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
                        {[...Array(20)].map((_, i) => (
                            <div
                                key={i}
                                className="absolute bg-orange-400 rounded-full blur-[1px]"
                                style={{
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        <div className="grid lg:grid-cols-2 gap-20 items-start">
                            <div className="animate-reveal lg:pt-6">
                                ...
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <p className="text-lg md:text-xl text-orange-100/60 leading-relaxed max-w-xl font-light">
                                            {content.heroDesc}
                                        </p>
                                    </div>

                                    <div className="flex flex-wrap gap-4">
                                        <a href="#downloads" className="h-14 px-8 bg-orange-500 hover:bg-orange-400 text-[#011a14] font-black tracking-widest uppercase text-xs rounded-sm transition-all flex items-center justify-center gap-2 group min-w-[180px]">
                                            {content.ctaDiscover}
                            ...
                            <div className="relative group animate-reveal [animation-delay:0.3s] flex items-center justify-center pt-20 lg:pt-0">
                                <div className="absolute inset-0 bg-orange-500/20 blur-[120px] rounded-full opacity-40 group-hover:opacity-60 transition-opacity duration-1000 animate-pulse-slow"></div>
                                <div className="relative z-10 floating">
                                    <img
                                        src={content.heroImage}
                                        alt="FungiPower All12 Label"
                            ...
                            {content.cards.map((item, i) => (
                                <div key={i} className="group glass-panel px-8 py-12 rounded-[2rem] hover-lift border-white/5 bg-white/[0.02] transition-all duration-500 hover:bg-white/[0.05]">
                                    <div className="mb-10 w-16 h-16 rounded-xl bg-orange-500/10 flex items-center justify-center border border-orange-500/20 group-hover:scale-110 transition-all duration-500">
                                        {i === 0 ? <Cpu className="w-8 h-8 text-orange-400" /> : i === 1 ? <Atom className="w-8 h-8 text-orange-400" /> : <Leaf className="w-8 h-8 text-orange-400" />}
                                    </div>
                                    <h3 className="section-title !text-2xl mb-6 tracking-tight font-outfit text-white">
                                        {item.title}
                                    </h3>
                                    <p className="text-orange-100/50 leading-relaxed font-light group-hover:text-orange-100/70 transition-colors">
                                        {item.desc}
                                    </p>
                                </div>
                            ))}
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        ...
                        <div className="grid lg:grid-cols-2 gap-20 mb-32 items-center">
                            <div>
                                ...
                                <p className="text-orange-100/60 text-lg md:text-xl font-light leading-relaxed">
                        ...
                        <div className="grid lg:grid-cols-2 gap-24 items-start">
                            <div>
                                ...
                                <p className="text-orange-100/60 text-lg md:text-xl font-light leading-relaxed mb-12">
                                    {content.advantageDesc}
                                </p>
                                <div className="space-y-6">
                                    {content.usps.map((item, i) => (
                                        <div key={i} className="flex items-center gap-5 group">
                                            <div className="w-8 h-8 rounded-full border border-orange-500/30 flex items-center justify-center group-hover:bg-orange-500 group-hover:border-orange-500 transition-all font-bold">
                            ...
                            <div className="glass-panel rounded-[2rem] p-10 bg-white/[0.02] border-white/5">
                                ...
                                <div className="pt-6 mt-6 border-t border-white/5">
                                    <div className="text-orange-100/40 text-sm italic font-medium">
                                        {content.tags}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-20 items-stretch">
                            ...
                            <div className="flex flex-col gap-8">
                                ...
                                <div className="glass-panel p-8 rounded-[2rem] bg-white/[0.02] border-white/5">
                                    <p className="text-orange-100/40 text-sm leading-relaxed italic">
                                        "{content.disclaimer}"
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="max-w-3xl mx-auto">
                            <div className="mb-12">
                                ...
                                <p className="text-orange-100/50 text-lg md:text-xl font-light leading-relaxed">
