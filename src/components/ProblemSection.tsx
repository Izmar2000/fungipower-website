...
const ProblemSection: React.FC<ProblemSectionProps> = ({ dict }) => {
    ...
    return (
        <section className="relative py-12 md:py-16 bg-[#021814] overflow-hidden">
            ...
            <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[600px] h-[600px] bg-orange-900/20 blur-[150px] rounded-full z-0"></div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="order-2 lg:order-1">
                        ...
                        <div className="space-y-6 section-description">
                            ...
                            <div className="pl-6 border-l-2 border-orange-500/50 py-1">
                    ...
                    <div className="order-1 lg:order-2 relative flex justify-center lg:justify-end group">
                        {/* Glow effect */}
                        <div className="absolute bg-orange-500/10 w-3/4 h-3/4 blur-3xl rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 group-hover:bg-orange-500/20 transition-all duration-700"></div>

                        {/* Science/Lab Image container with glass effect */}
                        <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-2xl group-hover:border-orange-500/30 transition-all duration-500">
                            <img
