...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* Clean horizontal orange → red gradient */}
      {/* No dark overlay needed on the left; the gradient itself provides contrast */}

      {/* 1. Subtle dark fade at the top for logo legibility */}
