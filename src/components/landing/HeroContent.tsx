...
export const HeroContent = () => {
  return (
    <div className="flex flex-col items-start text-left max-w-4xl py-2 relative z-20">
      ...
      <h1 className="text-4xl md:text-[50px] lg:text-[55px] xl:text-[60px] font-black text-white leading-[1.0] mb-10 tracking-[-0.02em] animate-fade-in-up uppercase flex flex-col items-start gap-2">
        <span className="block">Maximale</span>
        <span className="block">bio-efficiëntie</span>
      ...
      <div className="flex animate-fade-in" style={{ animationDelay: '0.6s' }}>
        <a href="#science" className="bg-white text-black px-8 py-4 rounded-xl text-[11px] font-black tracking-[0.2em] uppercase hover:bg-black hover:text-white transition-all shadow-2xl flex items-center gap-4 group">
          BEKIJK ONZE METHODIEK
