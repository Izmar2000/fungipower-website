        ...
        <section id="contact" className="py-24 md:py-32 bg-[#F8F9FA] text-slate-900 relative overflow-hidden border-t border-black/5 scroll-mt-24">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                <div className="flex flex-col items-center">
                    ...
                    <div className="max-w-3xl mx-auto w-full text-center mb-12 lg:mb-16">
                        <span className="inline-block text-[#F58220] text-xs font-black tracking-[0.2em] uppercase mb-4">
                            RESEARCH & DATA
                        </span>

                        <h2 className="text-4xl md:text-5xl lg:text-3xl font-black text-slate-900 mb-8 tracking-tight leading-[1.1]">
                            Stabiliteit door<br />Onafhankelijk Onderzoek.
                        </h2>

                        <div className="space-y-6 text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto font-medium">
                            <p>
                                Het fundament van FungiPower is de stabiliteit van de biologische processen. Wij bieden zekerheid aan de teler door uitgebreid onafhankelijk onderzoek en praktijkdata.
                            </p>
                        </div>
                    </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full bg-[#F8F9FA] border border-black/5 rounded-2xl px-5 py-4 text-slate-900 text-base focus:outline-none focus:border-[#F58220] transition-all font-medium shadow-inner"
                                        />
                                    </div>
                                    <div className="space-y-2">
