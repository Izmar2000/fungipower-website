      ...
      <div className={`max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between relative z-30 transition-all duration-500 ease-in-out ${isSolid ? "py-4" : "py-8"}`}>
        ...
        <a href="/" className="flex items-center relative group z-50">
          <img
            ...
            alt="FungiPower"
            className={`w-auto object-left object-contain transition-all duration-500 group-hover:scale-[1.05] drop-shadow-md hover:drop-shadow-xl h-24 md:h-32 lg:h-40 ${useDarkText ? "brightness-0 opacity-90" : "brightness-0 invert"}`}
          />
        </a>
