            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="flex-1 relative group w-full">
                        <div className="absolute inset-0 bg-orange-500/10 blur-[100px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                        ...
                        <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border border-white/10 aspect-square lg:aspect-[4/5]">
                            ...
                            <img
                                src="/images/champignon-kweker.png"
                                alt="Champignonkweker"
                    ...
                    <div className="flex-1 space-y-8">
                        ...
                        <div className="space-y-6">
                            {t.usps.map((item: any, i: number) => (
                                <div key={i} className="flex gap-4 group/item">
                                    <div className="mt-1 flex-shrink-0 w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-orange-400 border border-white/10 group-hover/item:border-orange-500/30 transition-all">
                                        <CheckCircle2 className="w-4 h-4" />
                                    </div>
                                    <div>
                                        <h4 className="text-white font-bold text-xl mb-1">{item.title}</h4>
                                        <p className="text-orange-100/50 text-base font-light leading-snug">{item.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="pt-2">
                            <button
                                ...
                                className="btn-standard bg-orange-500 hover:bg-orange-400 text-orange-950 shadow-xl"
                            >
                                {t.cta}
                            </button>
                        </div>
